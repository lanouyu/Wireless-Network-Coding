...
int main(int argc, char** argv) {
    ...
    //char *dst_ip_str = "10.189.23.19"; /* 目的IP地址字符串 */
    char *dst_ip_str = "192.168.1.255";
    u_char src_mac[6] = {0x00, 0x0c, 0x29, 0x2b, 0xaa, 0xd2}; /* 源MAC */
    //u_char dst_mac[6] = {0x60, 0x36, 0xDD, 0xCE, 0x9A, 0xA0}; /* 目的MAC */
    ...
    /* 初始化Libnet */
    if ( (handle = libnet_init(LIBNET_LINK, NULL, error)) == NULL ) {
...
//===========================================================================
   ...
   //===================================================  
    ...
    //======================================================================
        device = "ens33";
        src_ip_str = "192.168.1.143";
        dst_ip_str = "192.168.1.144";
        u_char src_mac[6] = {0x00, 0x0c, 0x29, 0xbf, 0xad, 0x3f}; /* 源MAC */
    ...
    //========================================================================== 
        device = "ens38";
        src_ip_str = "192.168.0.132";
        dst_ip_str = "192.168.0.131";
        u_char src_mac[6] = {0x00, 0x0c, 0x29, 0xbf, 0xad, 0x49}; /* 源MAC */
        u_char dst_mac[6] = {0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF}; /* 目的MAC */
        /* 把目的IP地址字符串转化成网络序 */
        dst_ip = libnet_name2addr4(handle, dst_ip_str, LIBNET_RESOLVE);
        /* 把源IP地址字符串转化成网络序 */
