...
{   
    ...
    char *src_ip_str = "10.189.126.207"; /* 源IP地址字符串 */
    char *dst_ip_str = "192.168.211.128"; /* 目的IP地址字符串 */
    ...
    //======================================================================
        ...
        strncpy(payload, "udp11111", sizeof(payload)-1); /* 构造负载的内容 */
    ...
    //========================================================================== 
          ...
          strncpy(payload, "udp22222", sizeof(payload)-1); /* 构造负载的内容 */
          payload_s = strlen(payload); /* 计算负载内容的长度 */
